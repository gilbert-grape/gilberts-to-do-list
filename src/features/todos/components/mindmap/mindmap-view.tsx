...
export function MindmapView({
  ...
  return (
    <div className="flex flex-col gap-2 overflow-hidden" style={{ maxHeight: "calc(100vh - 10rem)" }}>
      ...
      <div
        className="min-h-0 w-full flex-1 overflow-hidden rounded-lg border border-[var(--color-border)]"
        style={
          {
